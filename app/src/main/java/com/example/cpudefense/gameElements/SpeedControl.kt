...
class SpeedControl(var game: Game) {
    ...
    private var lockButton = SpeedControlButton(game, SpeedControlButton.Type.UNLOCK, this)
    private var returnButton = SpeedControlButton(game, SpeedControlButton.Type.RETURN, this)
