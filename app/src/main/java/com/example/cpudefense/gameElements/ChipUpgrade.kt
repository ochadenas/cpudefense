                  ...
                  var posX: Int, var posY: Int, val color: Int): Movable
{
    ...
    fun calculatePrice(): Int
    {
        ...
        when (type){
            ...
            Chip.ChipUpgrades.SELL -> {
                val refund = - chipToUpgrade.chipData.value * gameMechanics.heroModifier(Hero.Type.INCREASE_REFUND) * 0.01f
                return refund.toInt()
            }
    ...
    fun display(canvas: Canvas)
    {
        ...
        paintText.textSize = GameMechanics.chipTextSize * gameMechanics.resources.displayMetrics.scaledDensity
        paintText.alpha = 255
        ...
        paintText.textSize = (GameMechanics.chipTextSize - 0) * gameMechanics.resources.displayMetrics.scaledDensity
